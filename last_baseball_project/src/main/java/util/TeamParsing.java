...
public class TeamParsing {

	

	public TeamVo[] parsing_url() throws IOException {
		// TODO Auto-generated method stub
		String str_url = "https://www.koreabaseball.com/TeamRank/TeamRank.aspx";
	...
	public TeamVo[] parsing_file(String str_url) throws IOException {
		String file_url;
		if(str_url ==null||str_url.isEmpty())
			file_url = "src/main/java/util/html/팀순위   순위   KBO.htm";
		else 
			file_url = str_url;
