...
<div style="max-width:100%; max-heght:100%;">


  <div class="center">
      <label class="welcom_font">WELCOME B.B JOIN~♥♥♥10</label>			
   </div>	
...
<!-- input:입력창 css , input_s 입력창 크기  -->
	...
	<span>
		<input id="id" name="m_id" value="a11111"  class="input input_s" placeholder="아이디(4~10자리)"> 
				<input   class="button button_id" type="button" value="중복확인">	
	</span>	<br>
		...
		<input id="pwd" name="m_pwd" value="aaa111" class="input input_s" type="password" placeholder="비밀번호(영어 숫자 포함  4~10)"><br>
		<input id="pwd_check"    value ="aaa111"class="input input_s" type="password" placeholder="비밀번호 확인"><br>
		
		<input id="e_mail" value="xxx@xxx.com"name="m_email" class="input input_m" placeholder="E-MAIL(XXXX@XXXX.XXX형식입니다.)"><br>	
		<input id="tel" name="m_tel" class="input input_s" placeholder="연락처"><br>
		
		
		<!-- 주소검색 버튼  -->
		<input id="zip_code" name="m_zip_code" class="input input_s" type="text" placeholder="우편번호"> 	 	
		
		<input type="button"  class="button button_id" value="검색" onclick="pop();"><br>
		
		
		<input id="addr" name="m_addr" class="input input_m"  placeholder="주소">   <br>
		...
		<img  class="picture_size" src="images/기아.png" >
		<input type="radio" name="t_name" value="kia">
	
		<img class="picture_size" src="images/넥센.png" >
		<input type="radio" name="t_name" value="nexon">	
	
		<img class="picture_size" src="images/두산.png" >
		<input type="radio" name="t_name" value="nexon">	
	
		<img class="picture_size" src="images/로떼.png">
		<input type="radio" name="t_name" value="nexon">	
		
		<img class="picture_size" src="images/삼성.png" >
		<input type="radio" name="t_name" value="nexon">	<br>
		
		<img class="picture_size" src="images/에스케이.png" >
		<input type="radio" name="t_name" value="nexon">	
		
		<img class="picture_size" src="images/엔씨.png" >
		<input type="radio"  name="t_name" value="nexon">	
		
		<img class="picture_size" src="images/엘쥐.png" >
		<input type="radio" name="t_name" value="nexon">	
		
		<img class="picture_size" src="images/케이티_위즈.png" >
		<input type="radio" name="t_name" value="nexon">	
		
		<img class="picture_size" src="images/한화.png" >
		<input type="radio" name="t_name" value="nexon"><br>
		...
		<input id="sub" type="button"  class="button button_id"  value="     	   가입    	     "><br>
