...
<form method="post" id="insertBoardFrm" enctype="multipart/form-data">
    ...
    <h3 class="panel-title">커뮤니티 게시판 글수정하기</h3>
</div>
<div class="panel-body">
	<div class="form-group">
	  <label class="col-sm-2">제목</label>
	  <div class="col-sm-10"><input type="text" class="form-control" id="nc_title" value="${vo.nc_title }"></div><br>
	</div>
<br>
<textarea name="editor" id="editor" style="width: auto; height: auto;" >${vo.nc_contents }</textarea>
